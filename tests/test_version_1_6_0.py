...
class TestVersion161(unittest.TestCase):
    def test_application_version(self) -> None:
        self.assertEqual((VERSION_NAME, VERSION_CODE, __version__), ("1.6.1", 45, "1.6.1"))
    ...
    def test_packaging_version_and_stable_identity(self) -> None:
        ...
        self.assertIn('#define MyAppVersion "1.6.1"', installer)
        self.assertIn("VersionInfoVersion=1.6.1.45", installer)
    ...
    def test_pyinstaller_version_info(self) -> None:
        ...
        self.assertIn("filevers=(1, 6, 1, 45)", version_info)
        self.assertIn("prodvers=(1, 6, 1, 45)", version_info)
        self.assertIn("StringStruct('FileVersion', '1.6.1.45')", version_info)
        self.assertIn("StringStruct('ProductVersion', '1.6.1.45')", version_info)
