...
class TestVersion160(unittest.TestCase):
    def test_application_version(self) -> None:
        self.assertEqual((VERSION_NAME, VERSION_CODE, __version__), ("1.6.0", 44, "1.6.0"))
    ...
    def test_packaging_version_and_stable_identity(self) -> None:
        ...
        self.assertIn('#define MyAppVersion "1.6.0"', installer)
        self.assertIn("VersionInfoVersion=1.6.0.44", installer)
